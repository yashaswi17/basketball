...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Pepperfry's</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="http://127.0.0.1:8000/admin/blog/table">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="http://127.0.0.1:8000/admin/category/table">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('admin.user.create')}}">
              <i class="bi bi-list"></i><span>Add User</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>League</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('admin.league.create')}}">
              <i class="bi bi-circle"></i><span>Add League</span>
            </a>
          </li>
          <li>
            <a href="{{route('admin.league.table')}}">
              <i class="bi bi-circle"></i><span>View League</span>
            </a>
          </li>
       </ul>
      </li><!-- End Icons Nav -->
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('admin.tourism.create')}}">
              <i class="bi bi-circle"></i><span>Add tournament</span>
            </a>
          </li>
          <li>
            <a href="{{route('admin.tourism.table')}}">
              <i class="bi bi-circle"></i><span>View tournament</span>
            </a>
          </li>
        </ul>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">Pepperfry's</a>
